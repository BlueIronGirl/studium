 ...
 * und in Textdateien zu schreiben. <hr/>
...
public class FileIO
{
 ...
 // Unterdrueckung des default-Konstruktor,
...
/** oeffnet die Eingabedatei mit der Bezeichnung
 * filename
*/
public static void openInFile(String filename)
{
  ...
  try
    ...
    {
      System.out.println
        ("Fehler beim Oeffnen der Datei " + inFilename);
      System.exit(1);
    }
}

/** Schliesst die geoeffnete Eingabedatei 
*/
  ...
  public static int readIntFromFile()
   {
        ...
        if (in == null)
        {
          System.out.println("Keine Datei zum Lesen geoeffnet");
          System.exit(1);
         }
        int zahl = 0;
        try
        ...
        {
            System.out.println
            ("Eingabe-Fehler beim Einlesen einer Zahl von einer Datei");
            System.exit(1);
        }
...
/** oeffnet die Ausgabedatei mit der Bezeichnung
 * filename
*/
...
/** Schliesst die geoeffnete Ausgabedatei 
*/
