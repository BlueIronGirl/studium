...
//    double gewicht[][] = {{7500,20_000},{1000,2800},{150,400},{5,20}};
    ...
    System.out.println(zufall(40, 120));
    while (platz) {
  ...
  public static double zufall(double min, double max) {
    return Math.round(min + (Math.random() * (max - min + 1)) * 100.0) / 100.0;
  }
  ...
  public static void ausgabe() {
    ...
    System.out.println("Aktuelle Nutzfläche: " + Fahrzeug.getGesamtFlaeche()+" m2");
    System.out.println("Aktuelles Nutzgewicht: " + Fahrzeug.getGesamtGewicht()+" kg");
    System.out.println("Durchschnittliche Nutzfläche: " + faehre.getDurchschnittsFlaeche()+" m2");
    System.out.println("Durchschnittliches Nutzgewicht: " + faehre.getDurchschnittsGewicht()+" kg");
