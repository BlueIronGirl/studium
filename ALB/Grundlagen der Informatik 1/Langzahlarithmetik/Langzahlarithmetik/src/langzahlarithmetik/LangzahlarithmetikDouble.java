 ...
 */
public class LangzahlarithmetikDouble {
    public static void main(String args[])
    {
        int langzahl[] = new int[40]; //Speicherarray Summe der Koerner
        int koerner[] =  new int[40]; //Speicherarray Koerner
        koerner[0] = 1;
        double koernerD = 1;
        double langzahlD = 0;
        for(int i=1;i<=64;i++)//64 Felder des Schachbretts
        {
            ...
            System.out.print("\t"+langzahlD);
            System.out.println();
        }
        System.out.println("Double: "+langzahlD);
    }
    ...
    public static void ausgabe(int[] langzahl, int[] koerner,int schachfeldZaehler)
    {
        ...
        if (schachfeldZaehler == 1)
            System.out.println("Zaehler\tKoerner\t\t\t\t\tSumme der Koerner\t\t\tDouble"); //Ueberschrift
