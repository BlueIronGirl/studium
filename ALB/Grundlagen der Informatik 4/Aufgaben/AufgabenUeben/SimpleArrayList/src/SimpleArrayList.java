...
public class SimpleArrayList<E> implements SimpleList<E> {
   ...
   *
   * @see SimpleCollection#add(Object)
   */
   ...
   * inhaltsgleich ist
   *
   * @see SimpleCollection#remove(Object)
   */
   ...
   * Liste enthalten ist
   *
   * @see SimpleCollection#contains(Object)
   */
