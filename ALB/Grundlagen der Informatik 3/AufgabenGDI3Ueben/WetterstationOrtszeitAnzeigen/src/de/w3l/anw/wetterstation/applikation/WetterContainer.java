...
public class WetterContainer
{
  ...
  public WetterContainer(String dateiname)
  {
    try
    {
      ...
      // ... und anschließend einen Datensatz hinzufügen
  ...
  public void datensatzHinzufuegen()
  {
    ...
    if (einWetter != null)
    {
      if (getAnzahlDatensaetze() > 0)
      {
        ...
        /*
         * Der Datensatz wird nur hinzugefügt, wenn er neuer
   ...
   * den Index zurück. Wird das Objekt nicht gefunden, wird
   * -1 zurückgeliefert.
   * @param w
   * @return
   */
   ...
   * einem ungültigen Index wird null zurückgeliefert.
   * @param Nummer
   */
  ...
  /**
   * @return Vector<String> der alle Tage im gewünschten
   * Format enthält
   */
  ...
  /**
   * @return Vector<String> der alle lokalen Zeiten für
   * das vorgegebene Datum im gewünschten Format enthält, 
   * für die Wetterdaten vorhanden sind.
   */
  ...
  /**
   * Liefert das Wetter für einen gewünschten Zeitpunkt
   * @param gewZeitpunkt
   */
  ...
  /**
   * @return Vector<Wetter> der alle Wetterdaten für das
   * gewünschte Datum (Tag) enthält.
   */
