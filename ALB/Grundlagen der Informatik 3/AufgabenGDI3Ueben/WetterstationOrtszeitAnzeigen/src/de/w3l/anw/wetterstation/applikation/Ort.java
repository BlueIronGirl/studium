...
/**
 * Bezeichnet einen geografischen Ort, für den Wetterdaten
...
public class Ort implements Serializable
{
  ...
  /**
   * @return Breitengrad mit Unterscheidung (N)ord und (S)üd
   */
  ...
  /**
   * @return Längengrad mit Unterscheidung (W)est und (E)ast
   */
